...
class LandingPage{
    ...
    editBestHealth = "#mat-option-4 > .mat-option-text";
    editGoodHealth = "#mat-option-5 > .mat-option-text";
    editModerateHealth = "#mat-option-6 > .mat-option-text";
    editPoorHealth = "#mat-option-7 > .mat-option-text";
    editSickHealth = "#mat-option-8 > .mat-option-text";
