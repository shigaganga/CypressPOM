...
calenderEle =".mat-datepicker-toggle > .mat-focus-indicator" //":nth-child(5) > :nth-child(1) > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex";  //:nth-child(5) > :nth-child(1) > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix
//year1959="td[aria-label='1959'] div[class='mat-calendar-body-cell-content mat-focus-indicator']";    //":nth-child(5) > :nth-child(1) > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix";    //"td[aria-label='1959'] div[class='mat-calendar-body-cell-content mat-focus-indicator']";
...
magiT16= ".mat-field.ng-star-inserted > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix";  //modified //  //"#mat-option-13 > .mat-option-text";//Magitier 3
...
magiTier = "#mat-select-value-15"; //Modified           //"#mat-select-value-11";
...
nextButt = ".form-wrapper > .mat-raised-button";
nexthome=".form-wrapper > .mat-raised-button";
 expectedUrl = ("https://analytics.dzeecloud.com/medicareAdvantage_sandbox/preferences");
...
//click1959Year(){
//cy.get(this.year1959).wait(3000).click();//Modified
//}
//click1959Month(){
...
//clickMagitier(){
 //cy.get(this.magiTier).click().wait(1000);
//}
//clickmagi16(){
