...
selectDefaultCategory(categoryName){
    ...
    clickProviderFilter()
    {
     //cy.get('#mat-expansion-panel-header-4 > .mat-content > .mat-expansion-panel-header-title').contains('Provider filters').should('be.visible').click({ force: true });   
     cy.get('#mat-expansion-panel-header-1 > .mat-content > .mat-expansion-panel-header-title').contains('Provider filters').should('be.visible').click({ force: true });
     cy.wait(4000);
  }
