...
//       cy.intercept('POST', '/medicareAdvantage_sandbox/login').as('loginRequest');
...
//         console.log('Login Request:', interception.request);
//         console.log('Login Response:', interception.response);
//         expect(interception.response.statusCode).to.eq(200);
//       });
  
//       cy.url().should('not.include', '/login');
//       cy.url().should('include', '/manage-providers');
//     });
//   });
...
//     // Visit the page you need after login
...
it("Test12: This is to verify Back button Functionality on the manage-providers/provider-list page within PDP application", () => {
    ...
    providerPage12.clickLongTermCareCategory();2
    providerPage12.wait(2000);
